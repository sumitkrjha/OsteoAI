...
const UserInfoBar = ({screenwidth}) => {
  ...
  return (
    <>
          <div id="navbarwrapper" className='bg-white max-[1100px]:h-20 h-80 max-[570px]:w-[90%] max-[530px]:w-[85%] ml-2 max-[1100px]:ml-0 p-2 border-2 border-gray-300 rounded-2xl hover:shadow-lg'>
