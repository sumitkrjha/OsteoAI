  ...
  return (
    <>
        <div id="signupWrapper" className='bg-yellow-300 h-screen flex items-center justify-center'>
            <div id="signupContainer" className='bg-white sm:h-[85%] md:h-[90%] lg:h-[85%] sm:w-[70%] md:w-[50%] lg:w-[40%] xl:w-[30%] border-2 border-[#3B2B3F] rounded-3xl p-4 flex flex-col'>
