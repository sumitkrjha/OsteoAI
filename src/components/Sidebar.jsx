            ...
            <div id="menu" className='basis-[80%] p-2 flex flex-col'>
                <div id="list" className='basis-[90%] p-2'>
                    <section className='flex flex-col gap-3'>
                        <button className='h-12 w-48  p-3 flex justify-start items-center rounded-lg font-semibold hover:bg-[#3B2B3F] hover:text-green-300  focus:bg-[#3B2B3F] focus:text-green-300 gap-3'>
