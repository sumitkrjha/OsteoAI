    ...
    <>
      ...
      >
        <Form className='h-[72%] max-[660px]:h-[85%] max-[530px]:h-[95%] max-[400px]:h-[474px] max-[400px]:pt-4'>
          <div id="formContainer" className='h-full flex max-[660px]:flex-col p-2 max-[400px]:h-[477px]'>
              ...
              {isLoader ? <div id="loader"></div> : <>
                ...
                <div id='inputField' className='h-24 max-[660px]:h-10 w-full p-2 max-[660px]:p-0 flex max-[400px]:flex-col items-center justify-center'>
                  ...
                  <Field type="text" name="patientName" id="patientName" className='p-2 max-[400px]:w-[265px] border border-gray-400 hover:border-[#3B2B3F] focus:shadow-sm focus:shadow-[#3B2B3F] focus:border-[#3B2B3F] focus:outline-none rounded-lg basis-[70%]' />
                </div>
              ...
              <div id="result" className='basis-3/5 p-4 max-[530px]:py-0 flex max-[530px]:items-start items-center justify-center '>
                  <div id="resultCard" className='h-[98%] w-[75%] max-[400px]:h-[98%] max-[400px]:w-[90%] max-[530px]:h-[53%] max-[530px]:w-[85%] bg-[#FFF] flex flex-col  max-[530px]:flex-row max-[400px]:flex-col items-center justify-center gap-3 border-2 border-black rounded-xl shadow-md shadow-[#3B2B3F]'>
                      ...
                      <img src={resultImage} alt='resultImage' className='h-[80%] max-[530px]:h-[95%] max-[400px]:h-[80%]' />
                  </div>
              </div> 
              </>
              }
