                ...
                <div id="formContainer" className='h-full p-4 flex max-[950px]:flex-col'>
                    <div id="dpWrapper" className='h-full basis-2/5 p-2 flex flex-col items-center'>
                        <div id="dpCircle" className='m-4 p-2 h-72 w-72 border-2 border-green-500 rounded-full flex items-center justify-center'>
                            <label htmlFor="avatar" className='bg-transparent h-64 w-64 border-2 rounded-full  flex items-center justify-center hover:border-[#3B2B3F] hover:pb-5 hover:shadow-lg hover:shadow-[#3B2B3F] cursor-pointer'
                            style={{
                    ...
                    <div id="formContainer" className=' m-4 basis-3/5 p-5'>
                        ...
                        <div id='inputField' className=' h-24 w-full p-2 flex items-center justify-center  max-[570px]:gap-2'>
