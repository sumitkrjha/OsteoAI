...
const ProfileForm = () => {
  ...
  return (
    <>
        ...
        >
            <Form className='h-[90%] max-[400px]:w-[297px]'>
                <div id="formContainer" className='h-full p-4 flex max-[950px]:flex-col'>
                    ...
                    <div id="formContainer" className='max-[400px]:m-0 m-4  p-5 basis-3/5 max-[400px]:p-2 max-[400px]:flex max-[400px]:flex-col max-[400px]:gap-5'>
