...
const Profile = () => {
  return (
    <>
        <div id="contentWrapper" className='bg-white h-full max-[660px]:h-[98%] max-[570px]:w-[90%] max-[530px]:w-[85%] max-[400px]:w-[110%] p-6 border-2 border-gray-300 rounded-2xl hover:shadow-lg '>
